defmodule ImgLoaderWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ImgLoaderWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ImgLoaderWeb.Gettext, "errors", msg, opts)
    end
  end
